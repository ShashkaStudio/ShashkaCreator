...
**ShashkaCreator** асболютно бесплатный и с открытым исходным кодом для асболютного каждого человека. Можете использовать библиотеку в асболютно любых целях и в асболютно любой форме.
