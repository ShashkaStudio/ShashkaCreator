...
* **keyColor** - код цвета, который не будет отрисовываться у спрайта. Если не хотите использовать эту функцию, то поставьте значение 0.
* **active** - активен ли спрайт. При значении false спрайт не будет отрисовываться в окне.
* **Примечание: по умолчанию библиотека ищет графические изображения в папке с .exe файлом.**
