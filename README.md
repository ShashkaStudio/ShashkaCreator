...
**ShashkaCreator** абсолютно бесплатный для асболютно любых целей и абсолютно любого использования. Скрывать там буквально нечего: пару файлов, которые открываются даже через обычный блокнот. 
