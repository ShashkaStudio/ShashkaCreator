...
Для отрисовки графики библиотека задействует **GDI**, так что она вполне подойдёт для создания мелких и средних проектов или для тех, кому просто хочется побаловаться или разобраться в WinAPi. У библиотеки есть очень много плюсов: вес всего около 40 килобайт, быстрота работы, крайне простая установка, оптимальная работа на слабых устройствах, независимость от сторонних библиотек. Всё, что вам нужно - это иметь устройство с **Windows** старше, чем **Windows 2000**, и хотя бы встроенную видеокарту.
